...
export const RUNTIME_FEATURES = {
  ...
  // the live FrameSnapshot. `lingo` is true because the parity gate is met: the TS run produces
  // post-Lingo frames matching the C++ oracle (orange furniture + transparent stars in
